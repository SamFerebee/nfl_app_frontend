...
const CreateTeamForm = ({sendToHome, user, setUser}) => {
    ...
    const genTeam = () =>{
        setFormData({
            logo: "https://www.clipartmax.com/png/middle/256-2564132_tags-notre-dame-fighting-irish.png",
            abbreviation: "ABC",
    ...
    return (
        <div id="fullCreateForm">
            ...
            <span id="createTeamLogo">Logo: <input type="text" name="abbreviation" id="logoField" onChange={changeData} value={formData.logo} placeholder="Link to a picture"/> </span>
